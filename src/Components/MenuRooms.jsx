...
const MenuRooms = () => {
  ...
  return (
    <>
      ...
      <div className="shadow-lg bg-white dark:bg-boxes w-full h-16 rounded-md hover:scale-105 hover:shadow-xl  transition-all flex flex-row items-center justify-between pl-6 pr-4" onClick={ideasRoom}>
          <div className="text-back dark:text-white font-monserrat font-extralight text-lg">GENERAL</div>
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="shadow-lg bg-white dark:bg-boxes w-full h-16 rounded-md hover:scale-105 hover:shadow-xl transition-all flex flex-row items-center justify-between pl-6 pr-4" onClick={designRoom}>
        ...
        <div className="shadow-lg bg-white dark:bg-boxes w-full h-16 rounded-md hover:scale-105 hover:shadow-xl transition-all flex flex-row items-center justify-between pl-6 pr-4" onClick={devRoom}>
        ...
        <div className="shadow-lg bg-white dark:bg-boxes w-full h-16 rounded-md hover:scale-105 hover:shadow-xl transition-all flex flex-row items-center justify-between pl-6 pr-4" onClick={testRoom}>
        ...
        <div className="shadow-lg bg-white dark:bg-boxes w-full h-16 rounded-md hover:scale-105 hover:shadow-xl transition-all flex flex-row items-center justify-between pl-6 pr-4" onClick={marketingRoom}>
